  ...
  return (
    <section className="py-10">
      ...
      <div className="mt-14">
        ...
        {/* מיקום תמונה – קורס / אפליקציה / תוצאה */}
        <div className="mt-6 aspect-video w-full max-w-xl overflow-hidden rounded-lg border-2 border-border bg-muted mx-auto relative">
          <Image
            src="/placeholder.svg"
            alt="קורס – אפליקציה / תוצאה"
            fill
